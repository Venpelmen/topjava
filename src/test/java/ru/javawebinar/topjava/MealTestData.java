...
public class MealTestData {
    public static final int NOT_PRESENT_MEAL_ID = -1;
    ...
    public static Meal getNotPresentMealForUpdate() {
        return new Meal(NOT_PRESENT_MEAL_ID, of(2015, Month.JUNE, 1, 18, 0), "Созданный ужин", 300);
    }
